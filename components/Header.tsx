  ...
  return (
    <header>
      <div className="p-4 flex justify-between items-center h-16 fixed top-0 left-0 right-0 z-10 bg-white dark:bg-black md:p-0 md:mb-16 md:static">
        ...
        <nav className={`absolute top-16 left-0 right-0 flex flex-col p-4 backdrop-blur-sm bg-white/80 dark:bg-black/80 shadow-2xl transition-all ease-in-out duration-300 ${isMenuOpen ? 'visible opacity-100 h-auto' : 'invisible opacity-0 h-0'} md:h-auto md:block md:static md:visible md:opacity-100 md:shadow-none`}>
